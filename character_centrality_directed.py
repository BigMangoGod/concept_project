...
write_weight(value,'chinese_directed/degree')
...
write_weight(value,'chinese_directed/eigenvector')
...
write_weight(value,'chinese_directed/closeness')
...
write_weight(value,'chinese_directed/betweenness')
...
# write_weight(value,'chinese_directed/kcore')
...
write_weight(value,'chinese_directed/pagerank')
...
write_weight(value,'chinese_directed/ci(l=%s)'%(l))
